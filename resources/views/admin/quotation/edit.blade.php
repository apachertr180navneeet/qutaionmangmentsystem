            ...
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div class="d-flex align-items-center gap-2 bg-light px-3 py-1 rounded-3 border" style="border-color: #e8e5f0 !important;">
                    ...
                    <label class="custom-mrp-switch mb-0" for="show_mrp">
                        <input type="checkbox" name="show_mrp" id="show_mrp" value="1" {{ $isMrpActive ? 'checked' : '' }}>
                        <span class="mrp-slider"></span>
                    </label>
                    <span class="badge {{ $isMrpActive ? 'bg-success' : 'bg-secondary' }}" id="mrpBadge" style="font-size: 0.72rem; letter-spacing: 0.5px; min-width: 65px; text-align: center;">{{ $isMrpActive ? 'SHOW MRP' : 'NO MRP' }}</span>
                </div>
            </div>
            <div class="card-body">
                <div class="row g-3">
