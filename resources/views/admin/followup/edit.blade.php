            ...
            <form action="{{ route('admin.followups.update', $followUp->id) }}" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="follow_up_date" class="custom-input no-icon @error('follow_up_date') is-invalid @enderror" value="{{ old('follow_up_date', $followUp->follow_up_date) }}" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="time" name="follow_up_time" class="custom-input no-icon @error('follow_up_time') is-invalid @enderror" value="{{ old('follow_up_time', $followUp->follow_up_time) }}">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="notes" class="custom-input no-icon @error('notes') is-invalid @enderror" rows="3">{{ old('notes', $followUp->notes) }}</textarea>
                        @error('notes') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                </div>
                <div class="pt-4 mt-3 border-top">
                    <button type="submit" class="btn-gradient-primary me-2"><i class="bx bx-save me-1"></i> Update Follow-up</button>
