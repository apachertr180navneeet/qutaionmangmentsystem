    ...
    <div class="card report-result-card">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2 border-bottom">
            ...
            <div class="d-flex gap-2 no-print">
                ...
                <a href="{{ route('admin.reports.export.pdf', ['report_type' => 'customer_wise', 'customer_id' => request('customer_id')]) }}" class="btn btn-danger btn-sm" target="_blank">
                    <i class="bx bxs-file-pdf me-1"></i> PDF
                </a>
                <a href="{{ route('admin.reports.export.excel', ['report_type' => 'customer_wise', 'customer_id' => request('customer_id')]) }}" class="btn btn-success btn-sm">
