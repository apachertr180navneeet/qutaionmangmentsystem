    ...
    <div class="card report-result-card">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2 border-bottom">
            ...
            <div class="report-actions no-print">
                ...
                <a href="{{ route('admin.reports.export.pdf', ['report_type' => 'monthly', 'month' => request('month', date('m')), 'year' => request('year', date('Y'))]) }}" class="btn-action btn-report-pdf" target="_blank">
                    <i class="bx bxs-file-pdf"></i>
                    <span>PDF</span>
                </a>
                <a href="{{ route('admin.reports.export.excel', ['report_type' => 'monthly', 'month' => request('month', date('m')), 'year' => request('year', date('Y'))]) }}" class="btn-action btn-report-excel">
