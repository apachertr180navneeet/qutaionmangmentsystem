            ...
            <form action="{{ route('admin.customers.store') }}" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="contact_person" class="custom-input no-icon @error('contact_person') is-invalid @enderror" value="{{ old('contact_person') }}">
                        @error('contact_person') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label custom-form-label">Email</label>
                        <input type="email" name="email" class="custom-input no-icon @error('email') is-invalid @enderror" value="{{ old('email') }}">
                        @error('email') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label custom-form-label">Phone</label>
                        <input type="text" name="phone" class="custom-input no-icon @error('phone') is-invalid @enderror" value="{{ old('phone') }}">
